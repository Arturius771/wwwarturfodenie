import { AFDatabase } from "./afdatabase.js";

const afdb = new AFDatabase();
const modules = [
  {
  ...
  },
  {
    ...
    module_software: [{ title: "Python 3.8", url: "https://www.python.org/" }],
  },
  {
...
modules.forEach((item) => afdb.insert(item));
